...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Joust2_MiSTer.git"
CORE_NAME=(Arcade-Joust2)
...
UPSTREAM_CORE_NAME=(Arcade-Joust2)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-Joust2.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Joust2.rbf)
